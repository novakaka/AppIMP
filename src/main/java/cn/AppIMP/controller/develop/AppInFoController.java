...
public class AppInFoController {
    ...
    @ResponseBody
    public String apkNameIsExist(@RequestParam String apkName){
        ...
        if(StringUtils.isNullOrEmpty(apkName)){
            ...
            if(appInfo==null){resultMap.put("apkName", "exist");}
            else {resultMap.put("apkName", "notExist");}
        }
    ...
    public String addSave(AppInfo appInfo,HttpSession session,HttpServletRequest request,
        ...
        appInfo.setDevId(((DevUser)session.getAttribute("user")).getId());
        appInfo.setStatus(1);
        try {
